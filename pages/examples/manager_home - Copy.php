        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['manager_id']; ?></div>
                ...
                <ul class="list">
                   ...
                   <li>
					...
					<li>
                        ...
                        <ul class="ml-menu">
							<li>
                                <a href="../../pages/forms/basic-form-elements.html">Register</a>
                            </li>
                            <li>
                                <a href="../../pages/forms/basic-form-elements.html">Profiles</a>
                            </li>
                            <li>
                                <a href="../../pages/forms/advanced-form-elements.html">Message</a>
                            </li>
