    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">FlexiCOMM</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['employee_id']; ?></div>
        ...
        <div class="container-fluid">
				...
				<div class="body">
                            ...
                            <ol class="breadcrumb">
								...
								<li class="active">
                                    <i class="material-icons">library_books</i> Project Detail
                                </li>
                            </ol>
														...
														<table class="table table-bordered table-striped table-hover dataTable js-exportable">
															...
															<tbody>
																					...
																					<form method="post" class="form-horizontal" role="form">
																						...
																						<div class="row clearfix">
																							...
																							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
																								<div class="form-group">
																									<div class="form-line">
																									<textarea name="task_description" id="task_description" cols="30" rows="5" class="form-control no-resize" placeholder="Enter Project Description" required><?php echo $task_description; ?></textarea>
																									</div>
																								</div>
																							</div>
																						</div>
																...
																if(isset($_POST['update_task'])){
																	...
																	echo '<script>window.location.href="../../pages/tables/employee_view_project_list.php"</script>';
																	} else {
