...
<?php
// Create connection
$con=mysqli_connect("localhost","root","","angular1");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
						<form action="basic-form-elements.php" method="post">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <div ng-app="">
                                            <input type="text" name="username" class="form-control" placeholder="Username" ng-model="firstname"/>
